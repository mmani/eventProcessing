/* Generated By:JJTree&JavaCC: Do not edit this line. regExpGrammar.java */
package regExParsePkg;

public class regExpGrammar/*@bgen(jjtree)*/implements regExpGrammarTreeConstants, regExpGrammarConstants {/*@bgen(jjtree)*/
  protected JJTregExpGrammarState jjtree = new JJTregExpGrammarState();public static void main(String args []) throws ParseException
  {
 ...
 /*@bgen(jjtree) ELEMENT */
  ...
  public regExpGrammarTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x280,0x280,0x4c00,0x40,0x2000,};
   }

  /** Constructor with InputStream. */
  public regExpGrammar(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public regExpGrammar(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new regExpGrammarTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public regExpGrammar(java.io.Reader stream) {
  ...
  public regExpGrammar(regExpGrammarTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(regExpGrammarTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
