...
public class Exp2Q4 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			reg.setRegExp("a, ((!b) & c), ((!b) & c), ((!b) & c), ((!b) & c)");
			reg.buildParseTree();
		...
		try {
			...
			ConcurrentLinkedQueue<String> iq8 = new ConcurrentLinkedQueue<String>();
			ConcurrentLinkedQueue<String> iq9 = new ConcurrentLinkedQueue<String>();
			...
			ConcurrentLinkedQueue<String> aq8 = new ConcurrentLinkedQueue<String>();
			ConcurrentLinkedQueue<String> aq9 = new ConcurrentLinkedQueue<String>();
			...
			ConcurrentLinkedQueue<String> jq4 = new ConcurrentLinkedQueue<String>();
			...
			BufferedReader r8 = new BufferedReader(new FileReader("input.txt"));
			BufferedReader r9 = new BufferedReader(new FileReader("input.txt"));
			
			BufferedWriter w = new BufferedWriter(new FileWriter("output.txt"));

			RegExp reg = new RegExp();
			reg.setRegExp("a, ((!b) & c), ((!b) & c), ((!b) & c), ((!b) & c)"); // produces 255 states
			reg.buildParseTree();
			...
			InputOperator ioper8 = new InputOperator(r8, iq8);
			InputOperator ioper9 = new InputOperator(r9, iq9);
			...
			DummyOperator doper8 = new DummyOperator(iq8, aq8); // for NFA
			DummyOperator doper9 = new DummyOperator(iq9, aq9); // for NFA
			...
			JoinOperator joper4 = new JoinOperator(jq3, aq8, aq9, jq4);
			
			OutputOperator ooper = new OutputOperator(jq4, w);
			...
			Thread t18 = new Thread(ioper8);
			Thread t19 = new Thread(ioper9);
			...
			Thread t28 = new Thread(doper8);
			Thread t29 = new Thread(doper9);

			Thread t31 = new Thread(joper1);
			Thread t32 = new Thread(joper2);
			Thread t33 = new Thread(joper3);
			Thread t34 = new Thread(joper4);
		...
		try {
			...
			Automaton a8 = reg.constructAut(reg.expTree.root);
			a8 = Automaton.removeEps(a8);
			a8 = Automaton.determinize(a8); // use this to make it deterministic
			// a4 = Automaton.extendAllAlph(a4); // use this to keep it NFA
			a8.getAlphabet();
			...
			Automaton a9 = reg.constructAut(reg.expTree.root);
			a9 = Automaton.removeEps(a9);
			a9 = Automaton.determinize(a9); // use this to make it deterministic
			// a5 = Automaton.extendAllAlph(a5); // use this to keep it NFA
			a9.getAlphabet();
			...
			DFAOperator doper8 = new DFAOperator(iq8, aq8, a8); // for NFA
			DFAOperator doper9 = new DFAOperator(iq9, aq9, a9); // for NFA
			...
			System.out.println ("time taken : DFA + 4 joins " + elapsedTimeMillis);
			r1.close();
			r2.close();
			r3.close();
			r4.close();
		...
		try {
			...
			a8 = Automaton.removeEps(a8);
			// a8 = Automaton.determinize(a8); // use this to make it deterministic
			a8 = Automaton.extendAllAlph(a8); // use this to keep it NFA
			a8.getAlphabet();
			...
			a9 = Automaton.removeEps(a9);
			// a7 = Automaton.determinize(a7); // use this to make it deterministic
			a9 = Automaton.extendAllAlph(a9); // use this to keep it NFA
			a9.getAlphabet();
			...
			NFAOperator doper8 = new NFAOperator(iq8, aq8, a8); // for NFA
			NFAOperator doper9 = new NFAOperator(iq9, aq9, a9); // for NFA
			...
			System.out.println ("time taken : NFA + 4 joins " + elapsedTimeMillis);
			r1.close();
			r2.close();
			r3.close();
			r4.close();
